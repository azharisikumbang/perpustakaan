...
class LaporanPeminjamanExport implements FromView, WithDrawings, ShouldAutoSize, WithStyles
{
	...
	{
		return LaporanViewHandler::generateFromTemplate(new LaporanPeminjamanService($this->limit, $this->periode_tahun, $this->periode_bulan, $this->periode_hari), 'laporan.base-nested');
	}
