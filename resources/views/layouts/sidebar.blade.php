<aside class="fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75">
				...
				<ul class="space-y-2 pb-2">
					...
					<li>
						<a href="{{ route('dashboard') }}" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
							<!-- icon -->
							<svg class="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" viewBox="0 0 20 20">
