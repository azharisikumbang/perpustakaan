    ...
    <div class="mb-8">
    	<div class="block sm:flex items-center md:divide-x md:divide-gray-100 mb-4">
    		...
    		<div class="flex items-center sm:justify-end w-full">
	    		...
	    		<a href="{{ route('peminjaman.create') }}" class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-200 font-medium inline-flex items-center rounded-lg text-sm px-3 py-2 text-center sm:ml-auto">
                                            ...
                                            <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                                                <div class="bg-white rounded-lg shadow relative">
                                                    ...
                                                    <div class="p-6 pt-0 text-center">
                                                        ...
                                                        <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Anda Yakin ingin menghapus peminjaman ini ?</h3>
                                                        <button data-peminjaman-id="{{ $peminjaman['id'] }}" @click="deleteRakItem" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-3 py-2.5 text-center mr-2">
                                                            Ya, Saya Yakin
                                                        </a>
