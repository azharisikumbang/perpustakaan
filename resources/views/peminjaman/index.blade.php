    							...
    							<tr class="peminjaman-item hover:bg-gray-100">
    								...
    								<td class="p-4 whitespace-nowrap" x-data="{ deleteOpen: false }">
                                        <div class="space-x-2 justify-end flex">
                                            <a href="{{ route('peminjaman.show', ['peminjaman' => $peminjaman['id']]) }}" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                                Lihat Detail
                                            </a>
                                        </div>
    								</td>
